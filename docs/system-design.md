...
└── .switchboard/
    ...
    └── projects/
        └── <project-id>/       # per-project state (one subdirectory per project)
            ...
            │                   #   registry record (session_locator); legacy
            │                   #   session-link sidecars are migration-only.
