...
Commit message: `M2.7: integration test suite scaffolding`. M2.7 is the final code-shipping sub-milestone in M2; after user review, open the M2 PR per the "After M2.7 — open the M2 PR" section below.
...
8. Run `make test-live` locally — full live-harness integration suite passes.
