...
<button
  ...
  class={cn(
    ...
    copied ? "text-accent bg-border/60" : "text-muted hover:text-fg hover:bg-border/60",
    className,
  )}
  data-testid={testid}
...
>
  ...
  {:else}
    ...
    >
      ...
      <path d="M14 9V5.5A2.5 2.5 0 0 0 11.5 3H5.5A2.5 2.5 0 0 0 3 5.5V11.5A2.5 2.5 0 0 0 5.5 14H9" />
    </svg>
  {/if}
</button>
