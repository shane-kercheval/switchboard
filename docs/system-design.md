...
└── .switchboard/
    ...
    └── projects/
        └── <project-id>/       # per-project state (one subdirectory per project)
            ...
            │                   #   registry record (session_locator); session-link
            │                   #   sidecars have been fully removed.
