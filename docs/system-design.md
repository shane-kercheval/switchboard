...
| Programmatic compaction | unavailable (auto only) | unavailable (auto only) | unavailable (server-side; auto behavior unverified) |
...
- **Programmatic compaction** — Claude and Codex both auto-compact; none expose a triggerable `/compact` from headless. (Antigravity's compaction is server-side and unverified.) See open question 10.11.
