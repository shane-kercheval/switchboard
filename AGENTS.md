...
- **Frontend** — plain Svelte 5 + Vite + TypeScript + Tailwind v4 + shadcn-svelte. Lives at repo root (`src/`, `index.html`, `vite.config.ts`).
...
- *(none for M1.1 — extended starting M1.2.)*
